...
There is no major different between the two.
The Claude did the same thing, but the azure was easy to overcome as soon as possible. 
In AWS i correct S3 and it worked but in Azure i change the network security group to my IP address to restrict open access
